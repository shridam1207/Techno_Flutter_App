...
[
  ...
  },
  {
    ...
    'About': '''As powerful as it sounds was a mystery breaking process, only that it involved experimentation with electronic circuitry. Stunned in awe with a tinge of fire and adventure in their eyes, the hundred top teds of juniors squad, gushed out their ultra-fast testing and inference capabilities''',
    'Year': '2015',
    'iconpath':'images/2015_break.png'
  },
  {
    'Name': 'Poké Quest(J)',
    'About': ''' The adventure begins with a dream and motivation. There are no ways to escape from the epic battle, that will lead you to become a master! Technothlon gives the juniors their second challenge, this time with a machine programmed to fight with them and bring out the best of them all.''',
    'Year': '2015',
    'iconpath':'images/2015_poke.png'
  },
  {
    'Name': 'WATER ESCAPE TO GLORY(J)',
    'About': ''' As the name suggest, in the first event of Day 2, Technothlon gives the finalist their first experienced to compressed-fluid rockets or the Water Rockets. Get to know the basics of construction and working of a Water Rocket, put in your innovation and create your master piece.''',
    'Year': '2015',
    'iconpath':'images/2015_waterescape.png'
  },
  {
    'Name': 'WATER OF METTLES',
    'About': ''' The first event for the hauts Techno finale. And let me tell you, it was a war alright! The students bared their fangs of wit and sharpened their swords of logic with much enthusiasm as they looted, plundered, formed alliances, stratergised and slashed their way to victory.''',
    'Year': '2015',
    'iconpath':'images/2015_mettles.png'
  },
  {
    'Name': 'AIR CRASH INVESTIGATION',
    'About': ''''Once you eliminate the impossible, whatever reimages, however improbable, must be the truth...' In this second event of Hauts squad, the students had to use their \'detective instincts\' to unravel a mystery which led to the crash of a hypothetical aircraft.'''
    ,'Year': '2015',
    'iconpath':'images/2015_airinvestigation.png'
  },
  {
    'Name': '3RINGS(H)',
    'About': '''The third event for Hauts squad gave the students a hands on experience of basic robotics and circuit design. After an introduction to the world of robotics the students had to assemble their own differential drive bot and navigate through a maze. Two bonus rounds also tested their problem solving skills.'''
    ,'Year': '2015',
  ...
  },
  {
    ...
    'About': '''After three intriguing and gruelsome events, the top 5 teams of the juniors squad so far, faced each other in never-seen-before challenges called 'Apocalypso - The Final Battle'.''',
    'Year': '2015',
  ...
  {
    'Name': 'FINAL SHOWDOWN',
    'About': 'The phrase “Expect the unexpected” perfectly describes the final images event of Technothlon. All the events of the images are nerve-raking enough. Add to that the pressure of the championship decider in a surprise format round where the top 5 teams compete against each other head-on. ',
    'Year': '2014',
